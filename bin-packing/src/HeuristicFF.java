...
public class HeuristicFF {
	...
	// Constructor
	public HeuristicFF(List<Machine> machineList ,List<Job> jobsList, int machineCapacity, int binCapacity) {
...
*/
	...
	public String showResults() {
		String result = null;
		result += "First Fit Algorithm/On-line" + "\n"; 
